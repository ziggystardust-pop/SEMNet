...
def cmunext(dims=[16, 32, 128, 160, 256], depths=[1, 1, 1, 3, 1], kernels=[3, 3, 7, 7, 7],num_classes = 3):
    return CMUNeXt(dims=dims, depths=depths, kernels=kernels,num_classes=num_classes)


def cmunext_s(dims=[8, 16, 32, 64, 128], depths=[1, 1, 1, 1, 1], kernels=[3, 3, 7, 7, 9],num_classes = 3):
    return CMUNeXt(dims=dims, depths=depths, kernels=kernels,num_classes=num_classes)


def cmunext_l(dims=[32, 64, 128, 256, 512], depths=[1, 1, 1, 6, 3], kernels=[3, 3, 7, 7, 7],num_classes = 3):
    return CMUNeXt(dims=dims, depths=depths, kernels=kernels,num_classes=num_classes)
